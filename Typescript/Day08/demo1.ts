...
let skills:string[]=["Core Java",'Advnaced Java','Spring Boot','Hibernate','JSP','Angular 12','Docker','AWS','Jenking'];

let copiedArray=skills.slice(1,7);
console.log(`
    Original array
    ${skills}
    -------------------
    ...
    ${copiedArray}
`);
let copiedArray1=skills.slice(1);
console.log(copiedArray1)
let copiedArray2=skills.slice();
